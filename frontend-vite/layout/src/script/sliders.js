export function sliders(width) {
    ...
    if (document.querySelector('.long-proverbs')) {
        const ARR_LONG_SLIDER_PROVERBS = document.querySelectorAll('.long-proverbs');

        ARR_LONG_SLIDER_PROVERBS.forEach((slider, index) => {
            new Swiper(slider, {
                slidesPerView: 1,
                spaceBetween: 100,
                pagination: {
